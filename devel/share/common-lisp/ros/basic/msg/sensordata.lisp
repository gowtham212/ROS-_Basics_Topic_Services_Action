...
(cl:defmethod cl:initialize-instance :after ((m <sensordata>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'sensordata)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name basic-msg:<sensordata> is deprecated: use basic-msg:sensordata instead.")))

(cl:ensure-generic-function 'd-val :lambda-list '(m))
(cl:defmethod d-val ((m <sensordata>))
...
(cl:defmethod name-val ((m <sensordata>))
...
(cl:defmethod temp-val ((m <sensordata>))
...
(cl:defmethod hum-val ((m <sensordata>))
